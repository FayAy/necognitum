...
function drawStatus(veritas) {
	...
	document.querySelector(".status__index").style.color = color;
    document.querySelector(".status__accuracy").style.color = color;
    document.querySelector(".status__time").style.color = color;
    var timer = setInterval(function() {
    	if (veritas == 1) {
			color = '#' + i.toString(16) + 'FF' + i.toString(16);
		} else {
			color = '#FF' + i.toString(16) + i.toString(16);
		}
    	i = i + 4
        document.querySelector(".status__index").style.color = color;
        document.querySelector(".status__accuracy").style.color = color;
        document.querySelector(".status__time").style.color = color;
        console.log('#' + i.toString(16) + '0000');
        if (i > 254) clearInterval(timer);
