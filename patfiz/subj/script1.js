...
function startQuiz() {
	...
	switch(variant) {
		case 0:
			varfile = '/patfiz/subj/nos.json';
			break;
		case 1:
			varfile = '/patfiz/subj/kle.json';
			break;
		case 2:
			varfile = '/patfiz/subj/eig.json';
			break;
		case 3:
			varfile = '/patfiz/subj/vos.json';
			break;
		case 4:
			varfile = '/patfiz/subj/nas.json';
			break;
		case 5:
			varfile = '/patfiz/subj/imm.json';
			break;
		case 6:
			varfile = '/patfiz/subj/neo.json';
			break;
		case 7:
			varfile = '/patfiz/subj/dyh.json';
			break;
		case 8:
			varfile = '/patfiz/subj/zkt.json';
			break;
		case 9:
			varfile = '/patfiz/subj/vyd.json';
			break;
		case 10:
			varfile = '/patfiz/subj/sss.json';
			break;
		case 11:
			varfile = '/patfiz/subj/kro.json';
			break;
		case 12:
			varfile = '/patfiz/subj/end.json';
			break;
		case 13:
			varfile = '/patfiz/subj/neu.json';
			break;
		case 14:
			varfile = '/patfiz/all.json';
			break;
	}
